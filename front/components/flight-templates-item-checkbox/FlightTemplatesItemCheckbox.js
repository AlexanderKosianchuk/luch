import './flight-templates-item-checkbox.sass'
...
class FlightTemplatesItemCheckbox extends React.Component {
    constructor(props)
    {
        super(props);
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(FlightTemplatesItemCheckbox);
