import './flight-events-options.sass'
...
export default class FlightEventsOptions extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <nav className="flight-events-options navbar navbar-default">
