...
export default function SettlementsReportRow (props) {
    return (
        <div className="flights-settlements-report-row row">
            <div className="flights-settlements-report-row__col-title">
                { props.title ? props.title : <b><Translate value='results.settlementsReportRow.title' /></b> }
            </div>
            <div className="flights-settlements-report-row__col-value">
