        ...
        return (
            <ul className="nav navbar-nav">
                <li className={ this.props.viewType !== 'table' ? 'active' : '' } onClick={ this.handleChangeView.bind(this) }>
                    <a data="tree" href="#">{ I18n.t('flights.typeSwitch.treeView') }</a>
                </li>
                <li className={ this.props.viewType === 'table' ? 'active' : '' } onClick={ this.handleChangeView.bind(this) }>
                    <a data="table" href="#">{ I18n.t('flights.typeSwitch.tableView') }</a>
                </li>
            </ul>
        );
    }
...
export default connect(() => { return {} }, mapDispatchToProps)(TypeSwitch);
