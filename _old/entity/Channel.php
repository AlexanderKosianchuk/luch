...
// 	}
	...
	private function GetBinaryChannelWithExactSection($extTableName, $extChannels,
			$extMasks, $extStepLength, $extStartCopyTime,
			$extStartFrame, $extEndFrame)
	{
	...
	public function GetBinaryParam($extBpTableName,
			$extStartCopyTime, $extStepLength,
			$extStartFrame, $extEndFrame, $extChannels, $extMasks)
	{
		...
		$pointPairList = $this->GetBinaryChannel($bpTableName,
				$channels, $masks, $stepLength, $startCopyTime,
				$startFrame, $endFrame);
