...
define('UL_PDO_CON_STRING', 'mysql:host=127.0.0.1;dbname=db4');
// Example for SQLite: 
...
// logins table.
define('UL_PDO_AUTH_USER', 'dbUser');
...
// logins table.
define('UL_PDO_UPDATE_USER', 'dbUser');
...
// logins table
define('UL_PDO_DELETE_USER', 'dbUser');
...
define('UL_PDO_SESSIONS_USER', 'dbUser');
