...
var CHART_PARAM_INFO_GET_PARAM_COLOR = 'getColor';
...
function Param(flightId, 
	...
	this.flightIdInput = $("input#flightId"),
	this.apCount = 0;
	this.bpCount = 0;
	this.paramCount = 0;
	this.apArr = apParams;
	...
	//=============================================================
	this.scriptAddrParamTrans = location.protocol + '//' + location.host + "/asyncParamTrans.php";
	this.scriptParamInfo = location.protocol + '//' + location.host + "/asyncParamInfo.php";
};
//=============================================================
...
Param.prototype.GetApParam = function(paramCode, i, dfd){
	...
	$.ajax({
		...
		type: "POST",
		dataType: "json",
		url: self.scriptAddrParamTrans,
		async: true
	}).done(function(receivedParamPoints){
		apDataArray = receivedParamPoints;
		var pV = {
				action: CHART_PARAM_INFO_GET_PARAM_COLOR,
				flightId: self.flightId,
				paramCode: paramCode
		};
