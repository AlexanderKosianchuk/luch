...
//GENERAL INFO
///==================================================
function BruTypeEvents(langStr, srvcStrObj) {
...
BruTypeEvents.prototype.ShowGeneralInfoOptions = function() {
	var self = this;
...
BruTypeEvents.prototype.ShowGeneralInfoContent = function() {
	var self = this;	
