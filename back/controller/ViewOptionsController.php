    ...
    public function ShowParamList($flightId)
    {
        ...
        for ($i = 0; $i < count($flightApHeaders); $i++) {
            $paramList .= sprintf ("
                ...
                <label style='display:inline;'><input type='checkbox' class='flight-view-oprions-param ParamsCheckboxGroup' value='%s' data-id='%s' data-type='%s'/>
                %s, %s </label>
                </br>",
        ...
        for ($i = 0; $i < count($flightBpHeaders); $i++)
        {
            $paramList .= sprintf ("<input size='1' class='colorpicker-popup' style='background-color:#%s; color:#%s; display:inline;' data-paramcode='%s' value='%s'
                ...
                <input type='checkbox' id='bpCheckboxGroup' class='flight-view-oprions-param ParamsCheckboxGroup' value='%s' data-id='%s' data-type='%s'/>
                %s, %s</label></br>",
