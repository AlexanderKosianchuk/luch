...
class TCPDF {
	...
	public function Image($file, $x='', $y='', $w=0, $h=0, $type='', $link='', $align='', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false, $alt=false, $altimgs=array()) {
		...
		if (strpos($file, '$')) {
			// image from string
			$imgdata = substr($file, strpos($file, '$') + 1, strlen($file));
		} else if ($file[0] === '@') {
			// image from string
	...
	protected function getHtmlDomArray($html) {
		...
		$html = strip_tags($html, '<marker/><a><b><blockquote><body><br><br/><dd><del><div><dl><dt><em><font><form><h1><h2><h3><h4><h5><h6><hr><hr/><i><img><input><label><li><ol><option><p><pre><s><select><small><span><strike><strong><sub><sup><tcpdf><td><textarea><th><thead><tr><tt><u><ul>');
